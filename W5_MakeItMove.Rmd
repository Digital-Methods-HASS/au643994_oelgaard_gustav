...
Due to the large range of gdp it **makes it alot easier to visualise and explain**. 
...
To solve this problem, we can easily use the code we created earlier to find the richest country in 1952.
```{r}
gapminder %>% 
  filter(year == 2007) %>% 
  arrange(desc(gdpPercap))
